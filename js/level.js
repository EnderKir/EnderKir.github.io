(function() {
  ...
  Level.prototype.putWall = function(x, y, height) {
    //y - это дно стены в данном случае
  ...
  //Иногда трубы не идут ровно вверх и вниз.
  ...
  // Добавление флагштога - конец игры)))
